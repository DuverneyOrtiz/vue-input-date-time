...
var letterMonth = function (languaje, momentCurrent) {
    ...
    var monthCurrent = getMonth(momentCurrent);

    return month[languaje][monthCurrent]
};

var letterDays = function (languaje, size) {
    if ( languaje === void 0 ) languaje = 'es';
    if ( size === void 0 ) size = 'long';
...
var dayWeekStart = function (momentCurrent){
    if(momentCurrent !== undefined || momentCurrent !== null) {
        var data = (momentCurrent.get('year')) + "-" + (momentCurrent.get('month') + 1) + "-01";
        return moment(data).days()
    }    
